    ...
    <div class="row">
      <div class="col">
        <h3 class="text-center">
          <div class="insight-title--subtitle">La pequeña gran diferencia</div>
        </h3>
        <p class="text-center">Descubre cómo pequeñas acciones pueden generar grandes cambios para ti y para el medio ambiente.</p>
      </div>
      <img alt="productos naturales" class="lazyload img-fluid rounded col-12"
        data-sizes="auto"
