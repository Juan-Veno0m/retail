...
@section('description','El presente Política de Privacidad establece los términos en que Yolkan usa y protege la
información que es proporcionada por sus usuarios.') <!-- Meta Description -->
@section('opg')
  <!-- Twitter -->
  ...
  <meta property="og:description" content="El presente Política de Privacidad establece los términos en que Yolkan usa y protege la
  información que es proporcionada por sus usuarios."/>
  <meta property="og:type" content="og:website" />
  <meta property="og:url" content="{{URL::current()}}" />
  <meta property="og:image" content="{{asset('/img/gallery/privacy.png')}}" />
...
@section('content')
  ...
  <div class="container-fluid py-4">
    <div class="row justify-content-center">
      <div class="col-lg-6"><img src="{{asset('img/gallery/privacy.png')}}" class="img-fluid" alt="Política de Privacidad"></div>
    </div>
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <h1>Política de Privacidad</h1>
        <p>El presente Política de Privacidad establece los términos en que Yolkan usa y protege la información que es proporcionada
           ...
           lo hacemos asegurando que sólo se empleará de acuerdo con los términos de este documento. Sin embargo esta Política de
        ...
        <p>Nuestro sitio web podrá recoger información personal por ejemplo:
          ...
          o realizar una entrega o facturación.</p>
        ...
        <p>Yolkan está altamente comprometido para cumplir con el compromiso de mantener su información segura.
        ...
        <p>Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para almacenarse en su
          ...
          ellas las web pueden reconocerte individualmente y por tanto brindarte el mejor servicio personalizado de su web.</p>
        ...
        <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia.
          ...
          a menos de que usted así lo quiera y la proporcione directamente, . Usted puede aceptar o negar el uso de cookies,
          sin embargo la mayoría de navegadores aceptan cookies automáticamente pues sirve para tener un mejor servicio web.
          También usted puede cambiar la configuración de su ordenador para declinar las cookies. Si se declinan es posible
        ...
        <p>En cualquier momento usted puede restringir la recopilación o el uso de la información personal que es proporcionada
           ...
           o desmarcar la opción de recibir información por correo electrónico.  En caso de que haya marcado la opción de
        ...
        <p>Yolkan Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.</p>
      </div>
    </div>
  </div>
@endsection
