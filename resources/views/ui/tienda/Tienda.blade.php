        ...
        <div class="row justify-content-center pb-3">
          <div class="col-md-12 heading-section text-center ftco-animate fadeInUp ftco-animated">
            <h1 class="text-center">
              <div class="insight-title--subtitle">Tienda orgánica en línea</div>
            </h1>
          </div>
        </div>
        ...
        <div class="row">
          ...
          @foreach ($productos as $key => $p)
            ...
            <div class="col-lg-3 col-6">
              <div class="product"><?php $link=url('/producto/'.$slug.'/'.($p->ProductosID+3301)); ?>
                <a href="{{$link}}" class="img-prod" title="{{$p->ProductosNombre}}">
                ...
                <div class="text pt-3 px-3 text-center">
                  <h3><a href="{{$link}}" title="{{$p->ProductosNombre}}">{{$p->ProductosNombre}}</a></h3>
                </div>
              </div>
            </div>
          @endforeach
        </div>
        <div class="row justify-content-center"><div class="col-lg-3">{{$productos->links()}}</div></div>
      </div>
      <!-- CAT -->
        ...
        <div class="row justify-content-center pt-3">
          <div class="col-md-12 heading-section text-center ftco-animate fadeInUp ftco-animated">
            <h2 class="text-center">
              <div class="insight-title--subtitle">Explorar por categoría</div>
            </h2>
          </div>
        </div>
        <div class="row justify-content-center mb-5 icon-separetor">
