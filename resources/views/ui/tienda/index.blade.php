...
<html prefix="og: http://ogp.me/ns#" lang="es">
    <head>
        ...
        <link rel="preload" href="{{asset('/img/label-yolkan-xs.webp')}}" as="image" media="(max-width: 98px)">
    ...
    <body>
        ...
        <!-- Scripts -->
        <script src="{{asset('plugins/jquery/jquery@3.5.1.min.js')}}" defer></script>
        <script src="{{asset('js/lazysizes.min.js')}}" async></script>
        <script src="{{asset('plugins/bootstrap/bootstrap@4.5.2.bundle.min.js')}}" defer></script>
        <script src="{{asset('js/ui/index.js')}}" async></script>
        @yield('scripts')
    </body>
</html>
